          ...
          {signal.source_urls && signal.source_urls.length > 0 && (
            <div className="flex flex-wrap gap-2">
              {signal.source_urls.map((url, i) => {
                ...
                // Skip Google grounding redirect URLs
                if (hostname.includes('vertexaisearch.cloud.google.com')) return null;
                return (
                  <a
                    key={i}
                    href={url}
                    ...
                    className="inline-flex items-center gap-1 text-xs text-accent hover:underline truncate max-w-xs"
